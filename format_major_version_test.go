...
func TestFormatMajorVersionStableValues(t *testing.T) {
	...
	require.Equal(t, FormatPrefixSubstitution, FormatMajorVersion(31))
...
func TestFormatMajorVersions_TableFormat(t *testing.T) {
	...
	m := map[FormatMajorVersion][2]sstable.TableFormat{
		...
		FormatPrefixSubstitution:                    {sstable.TableFormatPebblev1, sstable.TableFormatPebblev7},
	}
...
func TestFormatMajorVersions_BlobFileFormat(t *testing.T) {
	...
	m := map[FormatMajorVersion]blob.FileFormat{
		...
		FormatPrefixSubstitution:             blob.FileFormatV2,
	}
